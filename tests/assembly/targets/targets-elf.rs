...
//@ revisions: riscv32ima_polygon_zkvm_elf
//@ [riscv32ima_polygon_zkvm_elf] compile-flags: --target riscv32ima-polygon-zkvm-elf
//@ [riscv32ima_polygon_zkvm_elf] needs-llvm-components: riscv
...
//@ revisions: riscv64ima_polygon_zkvm_elf
//@ [riscv64ima_polygon_zkvm_elf] compile-flags: --target riscv64ima-polygon-zkvm-elf
//@ [riscv64ima_polygon_zkvm_elf] needs-llvm-components: riscv
